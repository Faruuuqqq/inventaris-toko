// Add missing icons
const iconMap = {
    'ArrowUpRight': '<polyline points="7 14 3 10 7 6"></polyline><line x1="21" y1="10" x2="3" y2="10"></line>',
    'ArrowDownRight': '<polyline points="7 10 3 6 7 2"></polyline><line x1="21" y1="6" x2="3" y2="6"></line>',
};

// Extend the icon helper function
function iconExtended(name, className = '') {
    const existingIcons = {
        ...
        'Receipt': '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v6h6l-2 2 2 2H4v6h16v-6l-2-2 2-2H4v-6h6l-2-2 2-2H4V4z" />',
        ...
        'Truck': '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 3h1v4h-1 M2 3h1v18h-1 M20 7h4v4l-2 5h-2 M16 7h4 M16 13v8 M20 13v8" /><circle cx="10" cy="17" r="2" stroke-width="2" /><circle cx="20" cy="17" r="2" stroke-width="2" />',
        ...
        'Trash2': '<polyline points="3 6 5 6 21 6" stroke-width="2" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2 M10 11v6 M14 11v6" />',
    ...
    const svg = existingIcons[name] || '';
    return `<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' class='${className}'>${svg}</svg>`;
}

// Function for the view
function getProductTotalStock(productId) {
    // Simplified - in real app this would be an AJAX call
