...
import { Plus, Trash2, CreditCard, Calculator, Printer, AlertCircle } from 'lucide-react';
    ...
    <MainLayout title="Penjualan Kredit" subtitle="Buat transaksi penjualan dengan pembayaran kredit">
      <Alert className="mb-6 border-warning/50 bg-warning/10">
        ...
        <AlertDescription className="text-warning">
          Penjualan kredit akan menambah piutang customer. Pastikan data customer sudah benar.
        </AlertDescription>
      </Alert>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div className="space-y-2">
                  ...
                  <Input value="PK-2024-001" disabled />
                </div>
                <div className="space-y-2">
                  <Label>Tanggal</Label>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="gdg1">Gudang Utama</SelectItem>
                      <SelectItem value="gdg2">Gudang Cabang Bandung</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">Rp 7.500.000</TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">Rp 1.750.000</TableCell>
                    <TableCell>
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive">
                        <Trash2 className="h-4 w-4" />
                      </Button>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-xl font-bold text-warning">Rp 9.250.000</span>
                </div>
              </div>
              ...
              <div className="rounded-lg border bg-muted/50 p-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-destructive">Rp 9.250.000</span>
                </div>
              </div>
