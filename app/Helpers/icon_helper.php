<?php
/**
 * Complete Icon Library - Lucide Icons
 * 200+ icons untuk seluruh aplikasi
 */
...
function icon($name, $class = '') {
    $icons = [
        ...
        'AlertTriangleSolid' => '<path fill="currentColor" d="M12 2L1 21h22L12 2zm0 3.5L20.5 20h-17L12 5.5z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/>',
        ...
        'EyeOff' => '<path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7c.78 0 1.53-.09 2.24-.26"/><path d="M2 2l20 20"/>',
        ...
        'UserCog' => '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="8.01"/><line x1="19" x2="19" y1="16" y2="16.01"/><line x1="22" x2="22" y1="12" y2="12.01"/><line x1="16" x2="16" y1="12" y2="12.01"/>',
        ...
        'Building' => '<path d="M6 22V2a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v20"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-2"/><path d="M6 6h12"/><path d="M6 10h12"/><path d="M9 18h6"/>',
        'Building2' => '<path d="M10 12h4"/><path d="M10 8h4"/><path d="M14 22v-5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v5"/><path d="M6 22H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-2"/>',
        'Truck' => '<path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18h-4"/><path d="M19 18h1a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-2.48-3.1a1 1 0 0 0-.78-.376H15"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/>',
        ...
        'FilePlus' => '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><line x1="12" x2="12" y1="18" y2="12"/><line x1="9" x2="15" y1="15" y2="15"/>',
        'FileMinus' => '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><line x1="9" x2="15" y1="15" y2="15"/>',
        ...
        'Images' => '<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="M22 13v8a2 2 0 0 1-2 2H9"/><path d="m22 5-6 6"/><path d="m16 5 6 6"/><circle cx="9" cy="9" r="2"/>',
        ...
        'BellPlus' => '<path d="M19.3 14.8C20.1 16.4 21 17 21 17H3s3-2 3-9c0-3.3 2.7-6 6-6.7"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="M15 8v6"/><path d="M18 11h-6"/>',
        'BellMinus' => '<path d="M18.3 14.8C19.1 16.4 21 17 21 17H3s3-2 3-9c0-3.3 2.7-6 6-6.7"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="M15 8h-6"/>',
        'BellOff' => '<path d="M8.7 3A6 6 0 0 1 18 8a21.3 21.3 0 0 0 3 8.8"/><path d="M17 17v1a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-1"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="m2 2 20 20"/>',
        ...
        'Package2' => '<path d="M3 9h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9Z"/><path d="m3 9 2.45-4.9A2 2 0 0 1 7.24 3h9.52a2 2 0 0 1 1.8 1.1L21 9"/><path d="M12 3v6"/>',
        ...
        'Receipt' => '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M16 8h-6"/><path d="M16 12h-6"/><path d="M16 16h-6"/>',
        'ReceiptText' => '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>',
        ...
        'BadgePercent' => '<path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.78 4.78 4 4 0 0 1-6.74 0 4 4 0 0 1-4.78-4.78 4 4 0 0 1 0-6.74Z"/><path d="m15 9-6 6"/><path d="m9 9 1 1"/><path d="m14 14 2 2"/>',
        'Gift' => '<rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13"/><path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5 2.5 2.5 0 0 1 2.5 2.5v5"/><path d="M16.5 8v-2.5a2.5 2.5 0 0 1 5 0 2.5 2.5 0 0 1-2.5 2.5h-5"/>',
        ...
        'BarChart4' => '<path d="M3 3v18h18"/><path d="M13 17V9"/><path d="M18 17v-5"/><path d="M8 17V5"/>',
        'LineChart' => '<path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/>',
        'PieChart' => '<path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/>',
        'TrendingUp' => '<polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>',
        'TrendingDown' => '<polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/>',
        'Activity' => '<path d="M22 12h-4l-3 9L9 3l-3 9H2"/>',
        'ChartArea' => '<path d="M3 3v18h18"/><path d="M7 12v5"/><path d="M11 8v9"/><path d="M15 14v3"/><path d="M19 10v7"/>',
        ...
        'CalendarPlus' => '<rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><line x1="12" x2="12" y1="14" y2="20"/><line x1="9" x2="15" y1="17" y2="17"/>',
        'History' => '<path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l4 2"/>',
        'Timer' => '<line x1="10" x2="14" y1="2" y2="2"/><line x1="12" x2="15" y1="14" y2="11"/><circle cx="12" cy="14" r="8"/>',
        'Watch' => '<circle cx="12" cy="12" r="6"/><polyline points="12 6 12 12 16 14"/>',
        ...
        // Additional icons for project
        'ArrowRightFromLine' => '<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>',
        'Box' => '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22v-10"/>',
        'ClipboardList' => '<path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4"/>',
        'Layers' => '<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65"/><path d="m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65"/>',
        'StickyNote' => '<path d="M15.5 3H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3Z"/><path d="M14 3v4a2 2 0 0 0 2 2h4"/>',
        'Store' => '<path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7"/><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><path d="M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"/><path d="M2 7h20"/><path d="M22 7v3"/>',

        // Media
        'Play' => '<polygon points="5 3 19 12 5 21 5 3"/>',
        'Pause' => '<rect width="4" height="16" x="6" y="4"/><rect width="4" height="16" x="14" y="4"/>',
        'Stop' => '<rect width="16" height="16" x="4" y="4"/>',
        ...
        'Printer' => '<polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect width="12" height="8" x="6" y="14"/>',
        'Mouse' => '<rect width="12" height="18" x="6" y="3" rx="6"/><line x1="12" x2="12" y1="7" y2="13"/>',
        'Keyboard' => '<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 8v0"/><path d="M10 8v0"/><path d="M14 8v0"/><path d="M18 8v0"/><path d="M6 12v0"/><path d="M10 12v0"/><path d="M14 12v0"/><path d="M18 12v0"/><path d="M6 16v0"/><path d="M10 16v0"/><path d="M14 16v0"/><path d="M18 16v0"/>',
        ...
        'Hammer' => '<path d="m15 12-9.373 9.373a1 1 0 0 1-3.001-3L12 9"/><path d="m18 15 4-4"/><path d="m21.5 11.5-1.914-1.914A2 2 0 0 1 19 8.172v-.344a2 2 0 0 0-.586-1.414l-1.657-1.657A6 6 0 0 0 12.516 3H9l2.04 2.04a2.145 2.145 0 0 1 0 3.03L8.03 11.5a2.145 2.145 0 0 1-3.03 0L3 9.656V12c0 .984.328 1.937.915 2.706L6 17l2.25-2.25 2.625 2.625a1 1 0 0 0 1.414 0l.76-.76"/>',
        'Flag' => '<path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/>',
        'FlagTriangleRight' => '<path d="M7 22V2l10 5-10 5"/>',
        'Tag' => '<path d="M12 2H2v10l9.29 9.29c.94.94 2.48.94 3.42 0l6.58-6.58c.94-.94.94-2.48 0-3.42L12 2Z"/><path d="M7 7h.01"/>',
        'Tags' => '<path d="M9 5H2v7l6.29 6.29c.94.94 2.48.94 3.42 0l3.58-3.58c.94-.94.94-2.48 0-3.42L9 5Z"/><path d="M6 9.01V9"/><path d="m15 5 6.3 6.29a2.4 2.4 0 0 1 0 3.42l-3.58 3.58a2.4 2.4 0 0 1-3.42 0z"/>',
    ...
    return "<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='{$class}'>{$svg}</svg>";
}
