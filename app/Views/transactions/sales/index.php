    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between bg-surface rounded-xl border border-border p-4">
        ...
        <div class="flex gap-2">
            ...
            <div class="relative group">
                ...
                <!-- Dropdown Menu -->
                <div class="absolute right-0 mt-2 w-48 bg-surface border border-border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                    ...
                    <a href="<?= base_url('transactions/sales/credit') ?>" class="block px-4 py-2 text-sm text-foreground hover:bg-muted/50 border-t border-border last:rounded-b-lg">
                        ...
                        <tr class="border-b border-border hover:bg-muted/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span 
                                    ...
                                    :class="{
                                        'border-success/50 bg-success/10 text-success': sale.tipe_penjualan === 'CASH',
                                        'border-warning/50 bg-warning/10 text-warning': sale.tipe_penjualan === 'CREDIT'
                                    }"
                            ...
                            <td class="px-6 py-4 text-center">
                                <span 
                                    class="inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-semibold"
                                    :class="{
                                        'border-success/50 bg-success/10 text-success': sale.status_pembayaran === 'PAID',
                                        'border-warning/50 bg-warning/10 text-warning': sale.status_pembayaran === 'PENDING',
                                        'border-blue/30 bg-blue/10 text-blue': sale.status_pembayaran === 'PARTIAL',
                                        'border-destructive/50 bg-destructive/10 text-destructive': sale.status_pembayaran === 'CANCELLED'
                                    }"
                                ...
                                <div class="flex justify-end gap-1.5">
                                    ...
                                    <template x-if="sale.status_pembayaran !== 'PAID' && sale.status_pembayaran !== 'CANCELLED'">
                                        <button 
                                            ...
                                            class="inline-flex items-center justify-center rounded-lg border border-primary/50 bg-primary/5 hover:bg-primary/15 transition h-9 w-9 text-primary"
