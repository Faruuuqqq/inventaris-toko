...
<div class="page-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="<?= base_url('/transactions/purchases/detail/' . $purchaseOrder['id_po']) ?>" class="btn btn-outline-secondary">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="<?= base_url('/transactions/purchases/update/' . $purchaseOrder['id_po']) ?>" x-data="purchaseOrderForm()">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="nomor_po" class="form-label">Purchase Order Number</label>
                                    <input type="text" class="form-control" id="nomor_po" name="nomor_po" value="<?= old('nomor_po', $purchaseOrder['nomor_po']) ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tanggal_po" class="form-label">Date</label>
                                    <input type="date" class="form-control" id="tanggal_po" name="tanggal_po" value="<?= old('tanggal_po', $purchaseOrder['tanggal_po']) ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="estimasi_tanggal" name="estimasi_tanggal" value="<?= old('estimasi_tanggal', $purchaseOrder['estimasi_tanggal']) ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="Dipesan" <?= selected('Dipesan', old('status', $purchaseOrder['status'])) ?>>Ordered</option>
                                        <option value="Dibatalkan" <?= selected('Dibatalkan', old('status', $purchaseOrder['status'])) ?>>Cancelled</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="keterangan" name="keterangan" rows="2"><?= old('keterangan', $purchaseOrder['keterangan']) ?></textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?= base_url('/transactions/purchases/detail/' . $purchaseOrder['id_po']) ?>" class="btn btn-secondary">Cancel</a>
