...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('/finance/expenses/store') ?>" method="post">
                <?= csrf_field() ?>

                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="expense_number" class="form-label">Nomor Biaya</label>
                        <input type="text" class="form-control" id="expense_number" value="<?= $expense_number ?>" readonly>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="description" name="description"
                               value="<?= old('description') ?>" placeholder="Deskripsi biaya" required maxlength="255">
                    </div>

                    <div class="col-md-6">
                        <label for="amount" class="form-label">Jumlah (Rp) <span class="text-danger">*</span></label>
                        <input type="number" class="form-control" id="amount" name="amount"
                               value="<?= old('amount') ?>" placeholder="0" required min="1" step="1">
                    </div>
