...
<div x-data="customerManager()">
    ...
    <div class="mb-8 grid gap-4 grid-cols-1 md:grid-cols-3">
        <!-- Total Customers -->
        <div class="rounded-xl border border-border/50 bg-gradient-to-br from-primary/5 to-transparent p-4 hover:border-primary/30 transition-colors">
            <div class="flex items-center gap-4">
                ...
                <div class="text-right flex-shrink-0">
                    <p class="text-2xl font-bold text-foreground" x-text="customers.length"></p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-border/50 bg-gradient-to-br from-warning/5 to-transparent p-4 hover:border-warning/30 transition-colors">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-muted-foreground">menunggak</p>
                </div>
                <div class="text-right flex-shrink-0">
                    <p class="text-2xl font-bold text-foreground" x-text="customersWithPiutang"></p>
                </div>
            </div>
        </div>

        <!-- Total Piutang -->
        <div class="rounded-xl border border-border/50 bg-gradient-to-br from-destructive/5 to-transparent p-4 hover:border-destructive/30 transition-colors">
            <div class="flex items-center gap-4">
