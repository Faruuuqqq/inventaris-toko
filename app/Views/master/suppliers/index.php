...
<div x-data="supplierManager()">
    ...
    >
        ...
        >
            ...
            <!-- Modal Body -->
            <form @submit.prevent="submitForm" action="<?= base_url('master/suppliers/store') ?>" method="POST" class="p-6 space-y-5">
                <?= csrf_field() ?>
        ...
        async submitForm(event) {
            ...
            try {
                ...
                if (response.ok || response.status === 201) {
                    // Success
                    ModalManager.success('Data supplier berhasil ditambahkan', () => {
                        this.isDialogOpen = false;
                        form.reset();
                        this.errors = {};
                        // Reload page to refresh supplier list
