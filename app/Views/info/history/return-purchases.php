...
<div class="mb-6 rounded-lg border bg-card text-card-foreground shadow-sm p-6">
    <h3 class="text-lg font-semibold mb-4">Filter Histori Retur Pembelian</h3>
...
<div class="rounded-lg border bg-card text-card-foreground shadow-sm">
    <div class="p-6">
        <h3 class="text-xl font-semibold">Histori Retur Pembelian</h3>
    </div>
    <div class="p-0">
        <table class="table">
            <thead>
...
<script>
    function loadReturns() {
        ...
        fetch('/info/history/purchaseReturnsData?' + params.toString())
