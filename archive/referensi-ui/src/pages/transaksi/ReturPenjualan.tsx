            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input value="RTJ-2024-001" disabled />
                </div>
                <div className="space-y-2">
                  <Label>Tanggal</Label>
                ...
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="pj1">PJ-2024-001 - Toko Makmur</SelectItem>
                      <SelectItem value="pj2">PK-2024-002 - CV Sejahtera</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
                ...
                <div className="grid gap-4 md:grid-cols-4">
                  <div className="md:col-span-2">
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="prd1">Beras Premium 5kg (Qty: 10)</SelectItem>
                        <SelectItem value="prd2">Minyak Goreng 2L (Qty: 20)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className="text-right font-medium">Rp 105.000</TableCell>
                    <TableCell>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-xl font-bold text-warning">Rp 105.000</span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-4">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="potong">Potong Piutang</SelectItem>
                    <SelectItem value="tukar">Tukar Barang</SelectItem>
                  </SelectContent>
                </Select>
              </div>
